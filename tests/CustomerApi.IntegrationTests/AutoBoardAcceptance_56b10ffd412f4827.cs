...
namespace CustomerApi.IntegrationTests
{
    ...
    public class AutoBoardAcceptance_56b10ffd412f4827
    {
        ...
        {
            // The real DB connection string is injected by the test runner via the environment variable.
            ...
            Assert.That(dbConnStr, Is.Not.Null.And.Not.Empty,
                "AUTOBOARD_ACCEPTANCE_DB_DOTNET must be set by the test infrastructure");
